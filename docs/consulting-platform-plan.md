...
Status: **Phase 0 (Foundation) complete, 2026-08-14 — see §5 for phase-by-phase status**
...
| **1 — Leads/Pipeline** | Extended lead model + migration, Kanban + table views, lead detail with full activity timeline, follow-up due/overdue surfacing, convert-to-client, convert-to-project stub, lost reasons, dedupe-on-convert guard | Phase 0 |
